        ...
        <div className="space-y-3 max-w-xl mx-auto">
          ...
          >
            ...
            <div className="p-4 flex items-center justify-between">
              <p className="font-sf-mono text-primary/60 text-sm">SEND ME A DETAILED EMAIL OR DROP A CALL</p>
              <Button
          ...
          >
            ...
            <div className="p-4 flex items-center justify-between">
              <p className="font-sf-mono text-primary/60 text-sm">SCHEDULE A 30-MIN CALL WITH ME</p>
              <Button
            ...
            <div className="border border-primary/20 bg-background">
              ...
              <div className="divide-y divide-primary/10">
                <a
                  ...
                  className="p-4 flex items-center gap-3 hover:bg-primary/5 transition-colors"
                >

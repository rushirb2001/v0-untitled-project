...
export default function ContactPage() {
  ...
  return (
    <PageLayout title="CONTACT" subtitle="OPEN TO WORK AND PROJECT COLLABORATIONS">
      <div className="grid gap-4 md:gap-8 h-full">
        ...
        <div className="border border-primary/20 p-4 md:p-6 relative bg-background/80 backdrop-blur-sm flex flex-col items-center justify-center">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-primary/70 mb-4 font-black text-xs">Interested in collaborating? Drop me a message</p>
          </div>

    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-neutral-200 dark:bg-neutral-900">
      ...
      >
        ...
        <div className="relative h-full flex items-center">
          ...
          <div className="h-full relative flex flex-col items-center justify-center w-4/12">
            {/* Initials at top */}
            <div className="mb-8">
              <span 
          ...
          <div className="w-9/12 h-full flex flex-col justify-center items-center pr-16 pl-8 text-center">
            ...
            <div className="mb-6">
              <p 
                className="font-sf-mono tracking-wide opacity-80 font-black py-3.5 text-5xl"

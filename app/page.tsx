...
import { ArrowRight, Linkedin, Github, FileText, Mail, MapPin, ChevronLeft, ChevronRight } from "lucide-react"
...
export default function Home() {
  ...
  return (
    <>
      ...
      <motion.div
        className="fixed top-[60px] bottom-[60px] left-0 right-0 overflow-auto px-3 sm:px-4 md:px-6 lg:px-8"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.7, ease: [0.4, 0, 0.2, 1] }}
      >
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-[1fr_2fr] gap-3 sm:gap-4 md:gap-6 lg:gap-8 py-3 sm:py-4 md:py-6 lg:py-8 max-w-7xl mx-auto min-w-0 overflow-hidden">
          {/* Left Sidebar - Title/Subtitle */}
          <div className="md:sticky md:top-4 lg:top-6 self-start flex flex-col justify-center md:h-auto lg:h-[calc(100vh-12rem)] md:mb-4 lg:mb-0">
            ...
            <p className="text-xs sm:text-sm md:text-sm text-primary/50 font-sf-mono tracking-wider uppercase">
              DATA SCIENTIST • AI ENGINEER • ML RESEARCHER
            </p>
          </div>

          {/* Right Content */}
          <div className="w-full max-w-full flex flex-col justify-start min-w-0 overflow-hidden">
                ...
                >
                  ...
                  <div className="px-3 py-2 flex-1 flex flex-col justify-between overflow-hidden">
                    <p className="text-[10px] sm:text-xs text-primary/70 leading-relaxed font-mono tracking-tight text-justify py-4 px-3.5">
                      ...
                      across healthcare, astronomy, and enterprise AI domains.
                    </p>
                  ...
                  <div className="border-b border-primary/20 px-3 py-1.5 bg-primary/5">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <h3 className="text-xs font-sf-mono font-bold text-primary tracking-tighter">
                          FEATURED PROJECT
                        </h3>

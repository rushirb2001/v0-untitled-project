  ...
  const publicationsData: Publication[] = [
    {
      ...
      authors: ["Rushir Bhavsar", "Nilesh Kumar Jadav", "Umesh Bodkhe", "Rajesh Gupta", "Sudeep Tanwar", "Gulshan Sharma", "Pitshou N Bokoro", "Ravi Sharma"],
      citations: 14,
    },
    {
      id: "pub-2",
      ...
      authors: ["Harshil Sanghvi", "Rushir Bhavsar", "Vini Hundlani", "Lata Gohil", "Tarjni Vyas", "Anuja Nair", "Shivani Desai", "Nilesh Kumar Jadav", "Sudeep Tanwar", "Ravi Sharma", "Nagendar Yamsani"],
      citations: 12,
    },
    {
      id: "pub-3",

  ...
  const publicationsData: Publication[] = [
    {
      ...
      image: "/ai-segmented-brain-scan.png",
      abstract:
        "Improved data processing efficiency by 27% and elevated mammogram data quality by aggregating 7,000+ images from 7 sources, applying panoptic annotation and semantic segmentation, and leveraging convolutional autoencoders with data normalization techniques. Enhanced cancerous mammogram classification accuracy by 23% over baseline to 81%, by combining ResNet, U-Net, EfficientNet, MobileNet with one-shot transfer learning and Tree-based - Boosting Ensembling, culminating in academic dissemination.",
      link: "#",
      keywords: ["Deep Learning", "Medical Imaging", "Ensemble Methods", "Segmentation", "Transfer Learning"],
      authors: ["Rushir Bhavsar", "Dr. Jane Smith", "Dr. John Doe"],
      citations: 12,
    },
    {
      id: "pub-2",
      title: "Quantum Horizons: Predicting Asteroid Hazards with Supervised QML",
      venue: "Nirma University",
      period: "Jan 2023 - May 2023",
      location: "Ahmedabad, GJ, India",
      image: "/quantum-asteroid-paths.png",
      abstract:
        "Enhanced computational efficiency by 25.12% by applying advanced quantum feature mapping and dimensionality reduction on 4,000+ asteroid trajectory records, delivering scalable gains in precision and recall over classical ML approaches, and resulting in a research publication in IEEE Access Journal. Boosted asteroid classification accuracy by 23% over baseline to a 98.11% classification accuracy and 92.69% F1-score by developing a Quantum Machine Learning (QML) framework with Variational Quantum Circuits (VQC), Pegasos Quantum Support Vector Classifier (PQSVC), and Fidelity Quantum Kernels on IBM's 32-qubit simulator.",
      link: "#",
      keywords: ["Quantum Machine Learning", "Asteroid Classification", "IBM Quantum", "SVM", "Feature Mapping"],
      authors: ["Rushir Bhavsar", "Dr. Alice Johnson", "Prof. Robert Chen"],
      citations: 8,
    },
    {
      id: "pub-3",
      title: "Optimizing Edge AI: Resource-Efficient Computer Vision for IoT Devices",
      venue: "IEEE International Conference on Edge Computing",
      period: "Mar 2023 - Aug 2023",
      location: "Virtual Conference",
      image: "/connected-vision-network.png",
      abstract:
        "This research presents novel techniques for optimizing computer vision models for deployment on resource-constrained IoT edge devices. We developed a framework that reduces model size by 78% while maintaining 94% of the original accuracy through a combination of pruning, quantization, and knowledge distillation. Our approach enables real-time object detection and classification on devices with as little as 256MB of RAM, opening new possibilities for smart cameras, autonomous drones, and other edge computing applications where bandwidth and power are limited.",
      link: "#",
      keywords: ["Edge Computing", "Computer Vision", "Model Optimization", "IoT", "Knowledge Distillation"],
      authors: ["Rushir Bhavsar", "Dr. Michael Wong", "Dr. Sarah Parker"],
      citations: 5,
    },
  ]

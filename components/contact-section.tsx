...
export default function ContactSection() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="max-w-4xl w-full mx-auto text-center mb-12 relative z-10"
      ...
      <div className="w-full max-w-6xl mx-auto grid md:grid-cols-2 gap-12 px-4 relative z-10">
        <motion.div
        ...
        >
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <a href="mailto:contact@example.com" className="text-[#002366] dark:text-[#B9D9EB] hover:underline">
                    contact@example.com
                  </a>
                </div>
              </div>
          ...
          <div className="bg-white dark:bg-[#1F305E] rounded-xl shadow-lg p-8">
            <h3 className="text-2xl font-bold mb-6 text-[#002366] dark:text-white">Connect With Me</h3>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a
                ...
                className="flex items-center justify-center h-12 w-12 rounded-full bg-[#C6E2E9] dark:bg-[#002366]/40 hover:bg-[#002366] dark:hover:bg-[#002366] group transition-colors"
              >
                <Twitter className="h-6 w-6 text-[#002366] dark:text-[#B9D9EB] group-hover:text-white transition-colors" />
              </a>
            </div>

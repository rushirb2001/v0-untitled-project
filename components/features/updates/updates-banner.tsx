      ...
      <AnimatePresence>
        {!showDropdown && (
          <motion.div
            ...
            className="fixed top-14 md:top-16 right-0 md:right-auto md:left-0 z-[60] flex items-center justify-start space-x-2 py-1 px-2 border-l md:border-l-0 md:border-r border-b border-primary/20 bg-background cursor-pointer hover:bg-primary/10 transition-colors duration-150"
          >
      ...
      <AnimatePresence>
        {showDropdown && (
          <motion.div
            ...
            exit={{ opacity: 0, scaleY: 0, originY: 0 }}
            transition={{ duration: 0.3, ease: [0.4, 0, 0.2, 1] }}
            className="fixed top-14 md:top-16 right-0 md:right-auto md:left-0 z-[60] w-64 border border-primary/20 bg-background overflow-hidden"
          >
            {/* Header */}
            <motion.div
              initial={{ opacity: 0 }}
            ...
            >
              <div className="flex items-center justify-center gap-1.5">
                <span className="text-[10px] font-sf-mono tracking-wider text-primary/70">VIEW ALL</span>

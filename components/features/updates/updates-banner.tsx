  ...
  return (
    <>
      ...
      <div
        ...
        className="fixed top-14 md:top-16 left-0 z-40 flex items-center justify-start space-x-2 py-1 px-2 border-r border-b border-primary/20 bg-background/95 backdrop-blur-sm text-xs font-sf-mono text-primary/70 cursor-pointer hover:bg-primary/10 transition-colors rounded-br-md md:rounded-none"
      >
